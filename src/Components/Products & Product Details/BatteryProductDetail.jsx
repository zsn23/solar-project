...
const BatteryProductDetail = () => {
    const { id } = useParams();
    const product = Batteriesproducts.find((p) => p.id === parseInt(id));
            ...
            <div className="container-fluid ">
                ...
                <div className="row g-0 justify-content-center">
                    {Batteriesproducts.map((Batteriesproducts) => (
                        <div key={Batteriesproducts.id} className="col-lg-3 col-md-6 col-sm-6 col-12 mb-4 p-0 d-flex justify-content-center align-items-center">
                            <Link to={`/batteryProduct/${Batteriesproducts.id}`} className="Customcard d-flex flex-column text-decoration-none text-dark">
                                <div className="Customcard-img d-flex justify-content-center">
                                    <img src={Batteriesproducts.image[0]} alt={Batteriesproducts.title} className="Customcard-img-top" />
                                </div>
                                <div className="d-flex justify-content-between flex-column h-100">
                                    <div className="Customcard-info d-flex flex-column justify-content-center align-items-center">
                                        <span className="Customtext-title d-flex flex-nowrap">{Batteriesproducts.title} </span>
                                        <span className="Customtext-body">{Batteriesproducts.descrition}</span>
                                    </div>
                                    <div className="Customcard-footer border-top border-dark">
                                        <span className="Customtext-title">{Batteriesproducts.price}</span>
...
export default BatteryProductDetail;